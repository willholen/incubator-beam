...
class PipelineOptionsTest(unittest.TestCase):
  ...
  TEST_CASES = [
      ...
      },
      {
          ...
          'display_data': [
              DisplayDataItemMatcher('mock_option',
                                     'gs://my bucket/my folder/my file'),
  ...
  class MockOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls, parser):
      ...
      parser.add_argument('--mock_multi_option',
                          action='append',
                          help='mock multi option')
  ...
  class FakeOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls, parser):
      ...
      parser.add_argument('--fake_multi_option',
                          action='append',
                          help='fake multi option')
  ...
  def test_views_do_not_expose_options_defined_by_other_views(self):
    ...
    self.assertRaises(
        AttributeError, lambda: options.view_as(PipelineOptionsTest.MockOptions)
        .view_as(PipelineOptionsTest.FakeOptions).view_as(
  ...
  def test_experiments(self):
    ...
    self.assertEqual(sorted(options.get_all_options()['experiments']),
                     ['abc', 'def'])
  ...
  def test_extra_package(self):
    options = PipelineOptions([
        '--extra_package', 'abc', '--extra_packages', 'def', '--extra_packages',
        'ghi'
    ])
  ...
  def test_value_provider_options(self):
    ...
    class UserOptions(PipelineOptions):
      ...
      @classmethod
      def _add_argparse_args(cls, parser):
        parser.add_value_provider_argument('--pot_vp_arg1',

...
class NativeTypeCompatibilityTest(unittest.TestCase):
  ...
  def test_convert_to_beam_type(self):
    test_cases = [
        ...
        ('simple dict', typing.Dict[bytes, int], typehints.Dict[bytes, int]),
        ...
        ('simple unary tuple', typing.Tuple[bytes], typehints.Tuple[bytes]),
        ...
        ('complex tuple',
         typing.Tuple[bytes, typing.List[typing.Tuple[bytes,
        ...
        ('arbitrary-length tuple', typing.Tuple[int, ...],
         typehints.Tuple[int, ...]) if sys.version_info >= (3, 5, 4) else None,
        ...
        ('complex dict', typing.Dict[bytes,
                                     typing.List[typing.Tuple[bytes,
                                                              _TestClass]]],
         typehints.Dict[bytes, typehints.List[typehints.Tuple[bytes,
                                                              _TestClass]]]),
  ...
  def test_generator_converted_to_iterator(self):
    self.assertEqual(typehints.Iterator[int],
  ...
  def test_convert_nested_to_beam_type(self):
    ...
    self.assertEqual(typehints.List[typing.Dict[int, str]],
                     typehints.List[typehints.Dict[int, str]])

  def test_convert_to_beam_types(self):
    typing_types = [
        bytes, typing.List[bytes], typing.List[typing.Tuple[bytes, int]],
        typing.Union[int, typing.List[int]]
    ]
    beam_types = [
        bytes, typehints.List[bytes], typehints.List[typehints.Tuple[bytes,
                                                                     int]],

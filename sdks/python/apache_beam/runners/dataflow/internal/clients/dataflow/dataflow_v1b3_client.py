...
class DataflowV1b3(base_api.BaseApiClient):
  ...
  class ProjectsJobsDebugService(base_api.BaseApiService):
    ...
    SendCapture.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path=
        u'v1b3/projects/{projectId}/jobs/{jobId}/debug/sendCapture',
...
the status of jobs that are running in `us-central1`.
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=[u'jobId', u'projectId'],
        query_params=[
            u'endTime', u'location', u'minimumImportance', u'pageSize',
  ...
  class ProjectsJobsWorkItemsService(base_api.BaseApiService):
    ...
    ReportStatus.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path=
        u'v1b3/projects/{projectId}/jobs/{jobId}/workItems:reportStatus',
  ...
  class ProjectsJobsService(base_api.BaseApiService):
    ...
    Aggregated.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=
        [u'filter', u'location', u'pageSize', u'pageToken', u'view'],
...
of jobs that are running in `us-central1`.
  ...
  class ProjectsLocationsJobsDebugService(base_api.BaseApiService):
    ...
    GetConfig.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path=
        u'v1b3/projects/{projectId}/locations/{location}/jobs/{jobId}/debug/getConfig',
        request_field=u'getDebugConfigRequest',
    ...
    SendCapture.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path=
        u'v1b3/projects/{projectId}/locations/{location}/jobs/{jobId}/debug/sendCapture',
        request_field=u'sendDebugCaptureRequest',
        request_type_name=
        u'DataflowProjectsLocationsJobsDebugSendCaptureRequest',
        response_type_name=u'SendDebugCaptureResponse',
        supports_download=False,
    )
...
the status of jobs that are running in `us-central1`.
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=[u'jobId', u'location', u'projectId'],
        query_params=[
            u'endTime', u'minimumImportance', u'pageSize', u'pageToken',
            u'startTime'
        ],
        relative_path=
        u'v1b3/projects/{projectId}/locations/{location}/jobs/{jobId}/messages',
        request_field='',
  ...
  class ProjectsLocationsJobsWorkItemsService(base_api.BaseApiService):
    ...
    Lease.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path=
        u'v1b3/projects/{projectId}/locations/{location}/jobs/{jobId}/workItems:lease',
        request_field=u'leaseWorkItemRequest',
    ...
    ReportStatus.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path=
        u'v1b3/projects/{projectId}/locations/{location}/jobs/{jobId}/workItems:reportStatus',
        request_field=u'reportWorkItemStatusRequest',
        request_type_name=
        u'DataflowProjectsLocationsJobsWorkItemsReportStatusRequest',
        response_type_name=u'ReportWorkItemStatusResponse',
        supports_download=False,
    )
...
jobs that are running in `us-central1`.
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[u'view'],
        relative_path=
        u'v1b3/projects/{projectId}/locations/{location}/jobs/{jobId}',
        request_field='',
...
status of jobs that are running in `us-central1`.
    ...
    GetMetrics.method_config = lambda: base_api.ApiMethodInfo(
        ...
        relative_path=
        u'v1b3/projects/{projectId}/locations/{location}/jobs/{jobId}/metrics',
        request_field='',
...
analyzes properly as well.
    ...
    Validate.method_config = lambda: base_api.ApiMethodInfo(
        ...
        relative_path=
        u'v1b3/projects/{projectId}/locations/{location}/sql:validate',
        request_field='',
  ...
  class ProjectsLocationsTemplatesService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path=
        u'v1b3/projects/{projectId}/locations/{location}/templates',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        ...
        relative_path=
        u'v1b3/projects/{projectId}/locations/{location}/templates:get',
        request_field='',
    ...
    Launch.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=[u'location', u'projectId'],
        query_params=[
            u'dynamicTemplate_gcsPath', u'dynamicTemplate_stagingLocation',
            u'gcsPath', u'validateOnly'
        ],
        relative_path=
        u'v1b3/projects/{projectId}/locations/{location}/templates:launch',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    WorkerMessages.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path=
        u'v1b3/projects/{projectId}/locations/{location}/WorkerMessages',
  ...
  class ProjectsTemplatesService(base_api.BaseApiService):
    ...
    Launch.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[
            u'dynamicTemplate_gcsPath', u'dynamicTemplate_stagingLocation',
            u'gcsPath', u'location', u'validateOnly'
        ],

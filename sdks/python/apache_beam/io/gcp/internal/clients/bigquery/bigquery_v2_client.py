...
class BigqueryV2(base_api.BaseApiClient):
  ...
  class JobsService(base_api.BaseApiService):
      ...
      self._upload_configs = {
          'Insert':
              base_api.ApiUploadInfo(
                  ...
                  resumable_path=
                  u'/resumable/upload/bigquery/v2/projects/{projectId}/jobs',
    ...
    GetQueryResults.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=[u'jobId', u'projectId'],
        query_params=
        [u'location', u'maxResults', u'pageToken', u'startIndex', u'timeoutMs'],
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=[u'projectId'],
        query_params=[
            u'allUsers', u'maxCreationTime', u'maxResults', u'minCreationTime',
            u'pageToken', u'projection', u'stateFilter'
        ],
        relative_path=u'projects/{projectId}/jobs',
        request_field='',
  ...
  class TabledataService(base_api.BaseApiService):
    ...
    InsertAll.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path=
        u'projects/{projectId}/datasets/{datasetId}/tables/{tableId}/insertAll',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=[u'datasetId', u'projectId', u'tableId'],
        query_params=
        [u'maxResults', u'pageToken', u'selectedFields', u'startIndex'],
        relative_path=
        u'projects/{projectId}/datasets/{datasetId}/tables/{tableId}/data',
        request_field='',
  ...
  class TablesService(base_api.BaseApiService):
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[],
        relative_path=
        u'projects/{projectId}/datasets/{datasetId}/tables/{tableId}',
        request_field='',

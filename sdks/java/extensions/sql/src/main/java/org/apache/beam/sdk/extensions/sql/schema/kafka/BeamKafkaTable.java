 ...
 * extend to convert between {@code BeamRecord} and {@code KV<byte[], byte[]>}.
 *
 */
public abstract class BeamKafkaTable extends BaseBeamTable implements Serializable {
  ...
  protected BeamKafkaTable(BeamRecordType beamSqlRowType) {
    super(beamSqlRowType);
  }

  public BeamKafkaTable(BeamRecordType beamSqlRowType, String bootstrapServers,
      List<String> topics) {
    super(beamSqlRowType);

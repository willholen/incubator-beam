...
public class BeamJoinRel extends Join implements BeamRelNode {
  ...
  @Override public PCollection<BeamRecord> buildBeamPipeline(PCollectionTuple inputPCollections,
    ...
    BeamRecordType extractKeyRowType = BeamRecordType.create(names, types);

    Coder extractKeyRowCoder = new BeamRecordCoder(extractKeyRowType);

    // BeamRecord -> KV<BeamRecord, BeamRecord>
  ...
  private PCollection<BeamRecord> standardJoin(
    ...
    PCollection<BeamRecord> ret = joinedRows
        ...
        .setCoder(new BeamRecordCoder(CalciteUtils.toBeamRowType(getRowType())));
    return ret;
  }

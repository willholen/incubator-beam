...
public class BeamAggregationRel extends Aggregate implements BeamRelNode {
  ...
  public PCollection<BeamRecord> buildBeamPipeline(PCollectionTuple inputPCollections
    ...
    BeamRecordCoder keyCoder = new BeamRecordCoder(exKeyFieldsSchema(input.getRowType()));
    ...
    BeamRecordCoder aggCoder = new BeamRecordCoder(exAggFieldsSchema());
    ...
    mergedStream.setCoder(new BeamRecordCoder(CalciteUtils.toBeamRowType(getRowType())));

...
public class CalciteUtils {
   ...
   */
  public static SqlTypeName getFieldType(BeamRecordType schema, int index) {
    return toCalciteType(schema.getFieldsType().get(index));
  }

  /**
   * Generate {@code BeamRecordType} from {@code RelDataType} which is used to create table.
   */
  public static BeamRecordType toBeamRowType(RelDataType tableInfo) {
    ...
    return BeamRecordType.create(fieldNames, fieldTypes);
  }

  /**
   * Create an instance of {@code RelDataType} so it can be used to create a table.
   */
  public static RelProtoDataType toCalciteRowType(final BeamRecordType that) {

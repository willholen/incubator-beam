...
public class BeamTextCSVTableIOReader
  ...
  protected BeamRecordType beamSqlRowType;
  protected CSVFormat csvFormat;

  public BeamTextCSVTableIOReader(BeamRecordType beamSqlRowType, String filePattern,
      CSVFormat csvFormat) {
  ...
  public PCollection<BeamRecord> expand(PCollection<String> input) {
    return input.apply(ParDo.of(new DoFn<String, BeamRecord>() {
          ...
          public void processElement(ProcessContext ctx) {
            ...
            ctx.output(BeamTableUtils.csvLine2BeamRecord(csvFormat, str, beamSqlRowType));
          }
        }));
  }
}

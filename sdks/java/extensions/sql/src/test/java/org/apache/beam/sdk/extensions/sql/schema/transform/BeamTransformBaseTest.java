...
public class BeamTransformBaseTest {
  ...
  public static void prepareInput() throws NumberFormatException, ParseException{
    ...
    inputRows = Arrays.asList(
        ...
        initBeamRecord(columnMetadata, Arrays.<Object>asList(1, 4000L, Short.valueOf("4"),
            Byte.valueOf("4"), 4.0F, 4.0, "string_row4", format.parse("2017-01-01 02:04:03"), 4)));
  }

  /**
   * create a {@code BeamRecordType} for given column metadata.
   */
  public static BeamRecordType initTypeOfSqlRow(List<KV<String, SqlTypeName>> columnMetadata){
   ...
   */
  public static BeamRecord initBeamRecord(List<KV<String, SqlTypeName>> columnMetadata) {
    return initBeamRecord(columnMetadata, Arrays.asList());
  }
  ...
  public static BeamRecord initBeamRecord(List<KV<String, SqlTypeName>> columnMetadata,
    ...
    BeamRecordType rowType = initTypeOfSqlRow(columnMetadata);

...
import static org.apache.beam.sdk.extensions.sql.TestUtils.buildBeamRecordType;
...
public class MockedBoundedTable extends MockedTable {
  ...
  public MockedBoundedTable(BeamRecordType beamSqlRowType) {
  ...
  public static MockedBoundedTable of(final Object... args){
    return new MockedBoundedTable(buildBeamRecordType(args));
  }

  /**
   * Build a mocked bounded table with the specified type.
   */
  public static MockedBoundedTable of(final BeamRecordType type) {

...
public class BeamSqlDslBase {
  ...
  public static BeamRecordType rowTypeInTableA;
  ...
  public static void prepareClass() throws ParseException {
    rowTypeInTableA = BeamRecordType.create(
  ...
  public void preparePCollections(){
    boundedInput1 = PBegin.in(pipeline).apply("boundedInput1",
        Create.of(recordsInTableA).withCoder(new BeamRecordCoder(rowTypeInTableA)));

    boundedInput2 = PBegin.in(pipeline).apply("boundedInput2",
        Create.of(recordsInTableA.get(0)).withCoder(new BeamRecordCoder(rowTypeInTableA)));
  ...
  private PCollection<BeamRecord> prepareUnboundedPCollection1() {
    TestStream.Builder<BeamRecord> values = TestStream
        .create(new BeamRecordCoder(rowTypeInTableA));

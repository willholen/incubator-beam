...
public class BeamSqlDslUdfUdafTest extends BeamSqlDslBase {
  ...
  public void testUdaf() throws Exception {
    BeamRecordType resultType = BeamRecordType.create(Arrays.asList("f_int2", "squaresum"),
  ...
  public void testUdf() throws Exception{
    BeamRecordType resultType = BeamRecordType.create(Arrays.asList("f_int", "cubicvalue"),
        Arrays.asList(Types.INTEGER, Types.INTEGER));
